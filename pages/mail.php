                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block" valign="top">
                                        ...
                                        <h5>Bonjour '.$data['nom'].' ,</h5>
                                        Pour modifier votre mot de passe CCGIM, vous devez cliquer sur le lien ci-dessous.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="'.$domaine.'/update-pw/'.$mailToken.'" class="btn-primary" itemprop="url">Modifier votre mot de passe</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
