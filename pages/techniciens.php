            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 order-box-1">
                    <div class="service-details-content">
                        ...
                        <div class="top">
                            <h2>Louer un technicien sur CCGIM </h2>
                            <div class="img-box">
                        ...
                        <div class="service-details-text-box1">
                           <p>
                               Nous avons dans notre portfolio les corps de métier (les partenaires techniques en bâtiments) pour tous vos besoins :<br>
                               Architecte, géomètre, topographe, dessinateur, maçon, plombier, électricien, peintre, calligraphe peintre et décorateur, staffeur, menuisier charpentier, ébéniste, jardinier paysagiste, technicien de froid, technicien multimédia et vidéo surveillance.
                           </p>
                        </div>
