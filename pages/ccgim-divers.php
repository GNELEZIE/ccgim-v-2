                    ...
                    <div class="thm-sidebar-box">
                        ...
                        <div class="view-all-service">
                            <div class="sidebar-title">
                                ...
                                <h3><span class="border-left"></span>Nos Services</h3>
                            </div>
                        ...
                        <div class="sidebar-contact-info-box">
                            <div class="img-box">
                                <div class="inner">
                                    <img src="<?=$cdn_domaine?>/media/sidebar-contact-info.jpg" alt="">
                                </div>
                                ...
                                <div class="sec-title center text-center">
                                    <div class="sub-title">
                                        <h6>
                                            ...
                                            Prendre un dendez-vous
                                            <span class="border-right"></span>
                                        </h6>
                                    </div>
                                </div>
                                <h3><a href="tel:002250707856528">+225 07 07 85 65 28</a></h3>
                                <p>Notre équipe composée de professionnels qualifiés et expérimentés qui sont à votre disposition.</p>
                                <div class="btn-box">
                                    <a class="btn-one" href="tel:002250707856528">
                                        <span class="txt">Appelez-nous</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-8 col-lg-7 order-box-1">
                    <div class="service-details-content">
                        ...
                        <div class="service-details-text-box1">
                           <h6 class="py-1"> •	Clés minutes,</h6>
                           <h6 class="py-1"> •	Infographie et mini imprimerie (LOGO, Faire part, carte de Viste, calendrier… diplômes, tableaux)</h6>
                           <h6 class="py-1"> •	Photos minutes</h6>
                           <h6 class="py-1"> •	Inscription en ligne</h6>
                           <h6 class="py-1"> •	Connections internet haut débit (CIE, SODECI, Impôts…)</h6>

                            <h5 class="py-2">Nos Techniciens : Comment les contacter</h5>
                           ...
                           <p>
                            ...
                            <h5 class="py-2">Comment construire avec le CCGIM</h5>
                       ...
                       <h5 class="py-2">Comment vendre ou acheter avec le CCGIM</h5>
                            <p class="p-0">- Identité</p>
                            <p class="p-0">- Contacts</p>
                            <p class="p-0">- Localité</p>
                            <p class="p-0">- Titre de propriété</p>
                            ...
                            <h5 class="py-2">Comment confier la gestion de mes biens au CCGIM</h5>
                            <p class="p-0">- Identité</p>
                            <p class="p-0">- Contacts</p>
                            <p class="p-0">- Localité</p>
                            <p class="p-0">- Titre de propriété</p>
                            ...
                            <h5 class="py-2">Comment louer avec le ccgim</h5>
                            <p>A travers notre site, cabinet ccgim.com
                           ...
                           <p>  Ces dispositions spécifiques au CCGIM permettent de respecter la dignité et l’intimité du locataire. Ceci permet au
                               CCGIM d’éviter les éventuels faux billets de banque ou des billets dégradés refusables par tous.</p>
